    ...
    <view class="floor" v-for="(item, index) in floorList" :key="index">
      ...
      <view class="floor-image-box">
        ...
        <view class="right-image-box">
          <navigator :url="child.navigator_url" class="right-image-box-item" v-for="(child, i) in item.product_list"
            :key="i">
            <image :src="child.image_src" :style="{width: child.image_width + 'rpx'}" mode="widthFix" v-if="i!==0">
            </image>
          </navigator>
        </view>
      </view>
